...
from app.schemas.token import JWTMeta, JWTUser

JWT_SUBJECT = "access"
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 60 * 24 * 30  # Expiry is set to 30 days

'''
INPUT: jwt_content: Dict[str, str], secret_key: str, expires_delta: timedelta
OUTPUT: str (token)
'''
